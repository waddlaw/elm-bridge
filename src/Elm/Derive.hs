...
runDerive :: Name -> [Compat.UnitTyVarBndr] -> (Q Exp -> Q Exp) -> Q [Dec]
...
deriveAlias :: Bool -> A.Options -> Name -> [Compat.UnitTyVarBndr] -> [VarStrictType] -> Q [Dec]
...
deriveSum :: A.Options -> Name -> [Compat.UnitTyVarBndr] -> [Con] -> Q [Dec]
...
deriveSynonym :: A.Options -> Name -> [Compat.UnitTyVarBndr] -> Type -> Q [Dec]
